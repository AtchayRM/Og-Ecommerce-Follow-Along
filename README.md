...
# Milestone 17 : In this milestone, we will create an product details

key features:
Created product.js in backend (controllers)
then we changed product.js and user.js in model respectively
Atlast in Frontend we updated productDetails.jsx which is present in src followed by pages.
